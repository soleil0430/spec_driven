    ...
    public class JSONNode
    {
        ...
        public virtual int AsInt
        {
            get
            {
                ...
                var floatValue = AsFloat;
                if (float.Epsilon < Math.Abs(floatValue))
        ...
        public virtual double AsDouble
        {
            ...
            {
                double v = 0.0;
                if(double.TryParse(Value, NumberStyles.Float, new CultureInfo("en-US"), out v))
                    return v;
                return 0.0;
            }
            set
        ...
        public virtual long AsLong
        {
            get
            {
                ...
                if (double.Epsilon < Math.Abs(doubleValue))
